        ...
        <div id="mainbox" class="col-md-8">
            <div class="panel panel-default">
            	...
            	<div align="left" class="panel-body">
                    <form id="create-node" action="/publish/step2/{{ theApp.id }}" method="post" autocomplete="off" role="form">
                        {{
                            hidden_field(
                                security.getPrefixedTokenKey('upload-icon-' ~ theApp.id),
                                "value": security.getPrefixedToken('upload-icon-' ~ theApp.id)
                            )
                        }}
                        ...
                        <div class="app-create-box" style="margin: 10px auto;width:90%;">
                            <div style="text-align:center;"><label>{{ theApp.name }}</label></div>
