...
use Phosphorum\Auth\Auth;
use Phosphorum\Acl\Acl;
use Phosphorum\Mail\Mail;
...
class Bootstrap
{
    ...
    public function __construct()
    {
        ...
        if(APP_MAINTENANCE == 'down')
        {
          ...
          $this->di->setShared('router',  function() use ($config)
          {
                ...
                $router->setDefaults(['controller' => 'error', 'action' => 'route503']);
                $router->notFound(['controller' => 'error', 'action' => 'route503']);
    ...
    protected function initMarkdown()
    {
        $this->di->setShared('markdown', function () {
            ...
            // SF: No need escape the underscore
